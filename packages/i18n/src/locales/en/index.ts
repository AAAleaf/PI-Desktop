...
sklm: {
    ...
    modelLimitsGenericHint:
      "Not in the models.dev snapshot — these are generic conservative defaults, not published values. Set the model's real context and output sizes in Advanced; your number is then kept as is.",
