...
sklm: {
    ...
    modelLimitsGenericHint:
      "models.dev anlık görüntüsünde yok – bunlar yayımlanmış değerler değil, genel muhafazakâr varsayılanlardır. Gerçek bağlam ve çıktı boyutlarını Gelişmiş bölümüne girin; girdiğiniz değer sabitlenir.",
